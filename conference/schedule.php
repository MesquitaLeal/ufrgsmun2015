<div id="schedule" class="background">
    <div class="row gray-70 content">
        <div class="breadcrumb">
            <p>home > conference > schedule</p>
        </div>
...
<!--<svg class="gray-70-svg" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="40" viewBox="0 0 100 102" preserveAspectRatio="none">
    ...
    <div class="row gray-50 section-p content">
        <div class="col-md-12">
            <p class="center content-smaller">
                This is a temporary schedule. Changes might occur in the upcoming weeks.
            </p>
        </div>
    </div>
</div>
    ...
    <div class="row gray section-p content">
        <div class="col-lg-4">
            <div class="schedule-box">
                <h3 class="schedule-weekDay">Friday</h3>
                <h4 class="schedule-date">(October, 30th)</h4>
                <p>10:00 - 12:00 <span class="schedule-description">Cultural Tour</span></p>
                <p>10:30 - 14:00 <span class="schedule-description">Registration at Plaza San Rafael</span></p>
                <p>14:00 — 16:30 <span class="schedule-description">Revision of the Rules </span></p>
                <p>17:15 — 18:15 <span class="schedule-description">Opening Ceremony </span></p>
                <p>18:15 — 19:00 <span class="schedule-description">Opening Cocktail </span></p>
                <p>19:30 — 23:00 <span class="schedule-description">Happy Hour</span></p>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="schedule-box">
                <h3 class="schedule-weekDay">Saturday</h3>
                <h4 class="schedule-date">(October, 31st)</h4>
                <p>09:00 — 12:30 <span class="schedule-description">1st Session </span></p>
        ...
        <div class="col-lg-4">
            <div class="schedule-box">
                ...
                <p>22:30 — 04:00 <span class="schedule-description">UFRGSMUN’s Costume Party</span></p>
            </div>
        </div>
    </div>
    <div class="row gray content scheduleRow-2nd">
        ...
        <div class="col-lg-4">
            <div class="schedule-box">
                <h3 class="schedule-weekDay">Tuesday</h3>
                <h4 class="schedule-date">(November, 3rd)</h4>

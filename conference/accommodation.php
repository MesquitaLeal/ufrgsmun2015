<div id="accommodation" class="background">
    <div class="row gray-70 content">
        <div class="breadcrumb">
            <p>home > conference > accommodation</p>
        </div>
...
<!--<svg class="gray-70-svg" xmlns="http://www.w3.org/2000/svg" version="1.1" width="100%" height="40" viewBox="0 0 100 102" preserveAspectRatio="none">
    ...
    <div class="row gray-50 section-p content">
        <div class="col-md-12">
            <p class="center content-medium">
                The official accommodation sites of this year’s edition are the Master Express Alberto Bins Hotel, less than a 10 Min. walk from the Conference venue, and will grant special fares for UFRGSMUN participants. Additionally, delegates that decide to stay there will have free transportation to and from social events. Besides Master, there are other options nearby as well. The prices shown below are per person, per night. If you wish to get these prices, you must tell the place when you book that it’s for UFRGSMUN.
                <br/>Furthermore, we also offer the opportunity of staying in the house of one of the staff members. This free accommodation is very limited and cannot be guaranteed to all who are interested, but we will do our best. The form will be available mid-September.
            </p>
        </div>
    </div>
</div>
...
<div class="row gray content secondaryAccommodation-row">
    ...
    <div class="col-md-4">
        ...
        <p class="secondaryAccommodation-address">
            ...
            Centro Historico, Porto Alegre - RS<br/>
            (51) 3220.7000
        </p>
    </div>
</div>
